export default class MovieService {
  constructor() {
    ...
    this._token =
      'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI2ZjcyYTVlYzVlMDM3ZTNkYmY4ZTIyZjk5MGE5YmJiNCIsInN1YiI6IjY1ZTk5NzEzYWY5NTkwMDE4NGRkMGY2NCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.R_MXo9ox6N9Ic35aVwMGSqzMBCCsRPFeNSMfxwMKBLs';
    this.options = {
      method: 'GET',
      headers: {
